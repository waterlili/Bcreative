                    ...
                    <div id="success"></div>
                     ...
                     <form action="{{url('/register')}}" id="registerForm" method="post" name="registerForm">
                      <h4 class="bnr-sty shake">ثبت نام</h4>
                        ...
                        <div class="form-group">
                               <label><input type="radio" name="role" value="thinker">ایده پرداز</label>
                               <label><input type="radio" name="role" checked value="investment">سرمایه گذار</label>
                               <strong id="form-errors-password-confirm"></strong></span>
                        </div>
